...
POC_3_RAR_A1 <- function(n,norep) {
  ...
  for (m in 1:length(eta_vector))
  {
    ...
    for (i in 1:norep)
    {
      ...
      wert_2 = pcubature(f, c(-2.289, -Inf), c(2.289, -2.289))$integral
      wert_3 = pcubature(f, c(-2.289, 2.289), c(2.289, Inf))$integral
      alpha_2 = alpha_1 + wert_2 + wert_3
      ...
      wert_4 = pcubature(f, c(-2.289, -2.289, -Inf), c(2.289, 2.289, -2.289))$integral
      wert_5 = pcubature(f, c(-2.289, -2.289, 2.289), c(2.289, 2.289, Inf))$integral
...
POC_4_RAR_A1 <- function(n,norep) {
  ...
  for (m in 1:length(eta_vector))
  {
    ...
    for (i in 1:norep)
    {
      ...
      f <- function(x) (1/(2*pi* sqrt(1-korr_12^2) )) * exp( -1/(2*(1-korr_12^2))  * (  (x[1]-(mu_1))^2 +  (x[2]-(mu_2))^2 - 2* korr_12 * (x[1]-mu_1)*(x[2] - mu_2)) )  
      wert_2 = pcubature(f, c(-gpoc, -Inf), c(gpoc, -gpoc))$integral
      wert_3 = pcubature(f, c(-gpoc, gpoc), c(gpoc, Inf))$integral
      alpha_2 = alpha_1 + wert_2 + wert_3
